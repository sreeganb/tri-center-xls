...
subunit1 = st1.create_molecule("M", sequences["subunitalpha3"])
subunit2 = st1.create_molecule("G", sequences["subunitalpha6"])
subunit3 = st1.create_molecule("E", sequences["subunit10B"])
