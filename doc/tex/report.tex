...
\begin{minipage}{0.48\textwidth}
  ...
  \hline
  \end{tabular}
  \captionof{table}{Trifunctional crosslinks}
  \end{minipage}
\end{frame}
%
\begin{frame}
...
\begin{figure}
\centering
\includegraphics[width=0.41\textwidth]{test-figures/full-only-tri.pdf}
\caption{Distance distributions using trifunctional crosslinks (21 {\AA} linker length)}
\end{figure}
\begin{tabular}
  {lcc}
  \hline
