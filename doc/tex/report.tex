...
\begin{frame}
  \frametitle{Trifunctional cross linking mass spectrometry}
    \begin{figure}
      \centering
      \includegraphics[scale=1.0]{test-figures/tri-linker.eps}
...
\begin{frame}
  ...
  \begin{figure}
  \centering
  \includegraphics[width=0.45\textwidth]{test-figures/schematic.pdf}
  %\includegraphics[width=0.45\textwidth]{test-figures/swarm_plot_model_accuracy.pdf}
